...
/* Override Gradio CSS custom properties for inputs */
:root, .gradio-container {
    --input-background-fill: #ede8e2 !important;
    --input-background-fill-focus: #e8e2da !important;
