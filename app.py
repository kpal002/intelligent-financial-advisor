...
/* Note: input colors are set via gr.themes.Base().set() in Python  */
/* so Gradio injects them before our CSS, making overrides reliable. */
...
_theme = gr.themes.Base().set(
    # Input fields — warm off-white matching the page palette
